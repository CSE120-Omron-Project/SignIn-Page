        ...
        private MessagingStyleCommsAppData(Context context) {
            ...
            mMe =
                    new Person.Builder()
                            ...
                            .setIcon(
                                    IconCompat.createWithResource(context, R.drawable.omron))
                            .build();
            ...
            Person participant2 =
                    new Person.Builder()
                            ...
                            .setIcon(IconCompat.createWithResource(context, R.drawable.omron))
                            .build();
            ...
            mMessages.add(
                    ...
                    new NotificationCompat.MessagingStyle.Message("", 1528490641998l, participant1)
                            .setData("image/png", resourceToUri(context, R.drawable.omron)));
            ...
            mMessages.add(
                    new NotificationCompat.MessagingStyle.Message("Potential i/o switch faulty", 1528490645998l, participant2));
