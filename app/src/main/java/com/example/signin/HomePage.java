...
//                        textViewDate.setText("Date Deployed: " + inputDate);
                        ...
                        Cursor spotChecker = homepagedb.freeSpot(inputModel);

                        if(spotChecker.getCount() == 0){
                            ...
                            homepagedb.insertInOmron("0", "LD-250", "2", "Data Backup", "Daily", "10", "2021-05-04");homepagedb.insertInOmron("0", "LD-250", "3", "Wi-fi Environment", "6 Months", "30", "2021-05-04");
